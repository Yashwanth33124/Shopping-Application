...
const Header = () => {
  ...
  const commonSuggestions = [
    ...
    "LIPSTICK", "MATTE LIPSTICK", "GLOSSY LIPSTICK", "VELVET LIPSTICK",
    "PERFUME", "FRAGRANCE", "EAU DE PARFUM", "MIST", "FLORAL PERFUME",
    "HANDBAG", "BAG", "BAGS", "TOTE BAG", "SHOULDER BAG", "BACKPACK", "CLUTCH"
  ];
