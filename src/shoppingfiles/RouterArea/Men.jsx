  ...
  return (
    <>
      ...
      <section className="men2-page">
         <div className="men2-media-section" id="men2Section">

    <div className="men2-media-left">
      <img src="/images/m1.avif" alt="Denim Collection" />

      <div className="men2-text men2-text-left">
        <h2>Denim Edit</h2>
        <p>₹ 2,499</p>
      </div>
    </div>

    <div className="men2-media-right">
      <video src="/images/mv.webm" autoPlay muted loop playsInline />

      <div className="men2-text men2-text-right">
        <h2>Urban Casual</h2>
        <p>₹ 1,999</p>
      </div>
    </div>
